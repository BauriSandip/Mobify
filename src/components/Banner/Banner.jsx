        ...
        <div  className=' container'>
            <div style={{backgroundColor: data.bgColor}} className=' grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl'>
                ...
                <div data-aos="zoom-in" className='h-full flex items-center'>
                    <img src={data.image} alt="" className=' scale-125 w-[220px] md:w-[340px] mx-auto drop-shadow-2xl object-cover' />
                </div>
                {/* 3rd col */}
                <div className=' flex flex-col justify-center gap-4 p-6 sm:p-8'>
                    ...
                    <div data-aos="fade-up" data-aos-offset="0">
                        <button onClick={()=> navigate(data.path)} style={{color:data.bgColor}} className=' bg-white px-4 py-2 rounded-full '>Shop Now</button>
                    </div>
                </div>
            </div>
        </div>
